...
SECRET_KEY = os.environ.get("DJANGO_SECRET", "7xx%r5auJw1jJva")
...
ANOTHER_PEOPLE_APPS = ["django_countries","django_seed", "storages"]
...
if not DEBUG:
    ...
    AWS_S3_CUSTOM_DOMAIN = f"{AWS_STORAGE_BUCKET_NAME}.s3-website.ap-northeast-2.amazonaws.com"
